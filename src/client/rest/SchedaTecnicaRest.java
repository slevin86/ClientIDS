...
/**
 * Jersey REST client generated for REST resource:SchedatecnicaFacadeREST
 * [servizi_rest.schedatecnica]<br>
 * USAGE:
 * <pre>
 ...
 * @author Davide
 */
public class SchedaTecnicaRest {
    private WebResource webResource;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/ServerIDS/webresources";

    public SchedaTecnicaRest() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("servizi_rest.schedatecnica");
    }
